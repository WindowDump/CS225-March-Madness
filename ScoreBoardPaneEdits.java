 ...
 */
public class ScoreBoardPaneEdits {
    ...
    public TableView _start() {
        ...
        Bracket newBracket = new Bracket(players);
        TableView table_view = new TableView<>(generateDataInMap(newBracket));
    ...
    private ObservableList<Map> generateDataInMap(Bracket b) {
        int max = MAX_PLAYER_NUMBER;
        ObservableList<Map> allData = FXCollections.observableArrayList();
        for (int i = 1; i < max; i++) {
            Map<String, String> scoresRow = new HashMap<>();

            String value1 = b.getPlayerName();
            int value2 = b.scoreBracket(b);
            String sValue2 = "value2";

            scoresRow.put(Column1MapKey, value1);
            scoresRow.put(Column1MapKey, String.valueOf(value2));
